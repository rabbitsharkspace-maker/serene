...
**Serene** 是一款面向准备来到、刚刚抵达或正在澳洲建立生活的跨语言新居民（墨尔本首发）的智能化海外避坑与行动助手。首批场景覆盖留学生、新移民、Working Holiday、陪读家庭与外派工作者。

初到澳洲的人面对全英文罚单、账单、劳动或学校通知，以及租房押金纠纷时，常因不熟悉当地制度、语言和官方渠道而感到孤立无助。**Serene** 基于 Google AI 与云端能力，帮助用户读懂文件、核验当地官方依据、明确期限与下一步，并生成可编辑的英文沟通草稿，让每位新居民在澳洲落地时更有依据和底气。

---

## 🎯 面向人群与核心解决痛点 (Target Audience & Key Pain Points)

- **服务对象**：准备来澳、刚抵达或正在澳洲建立生活的跨语言新居民；墨尔本/维多利亚州首发，留学生为首批用户之一。
- **核心痛点**：
