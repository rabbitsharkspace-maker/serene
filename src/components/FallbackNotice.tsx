    ...
    <div className={`bg-amber-50 border border-amber-200/60 px-3.5 py-2.5 rounded-2xl flex items-start gap-2.5 shadow-sm ${className}`}>
      ...
      <p className="text-[10px] text-amber-900 leading-relaxed font-semibold">
        {isZh ? (
          ...
          <>
            <strong className="font-black">Preset sample — not live AI analysis.</strong>{' '}
            Gemini is busy right now. Below is a demo example of a similar scenario, not a real result for your input. Please try again later.
          </>
        )}
      </p>
    </div>
